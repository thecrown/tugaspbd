        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <div class="box-body pad">
              <?php echo form_open('Ketua_dashboard/cek_data_update/'.$data_anggota->id_anggota); ?>
              <div class="row">
              <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="date" id="myDate" name="tanggal" value="<?=$data_anggota->tahun_masuk; ?>" class="form-control pull-right" >
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="form-group">
            <?php $status = $data_anggota->status; ?>
                  <input type="radio" name="status" <?php if($status =="Aktif"){echo "checked"; } ?> value="Aktif" class="flat-red">
                    <label>
                      Aktif  
                    </label>
                  <br />
                  <input type="radio" name="status" <?php if($status =="NonAktif"){echo "checked"; } ?>  value="NonAktif" class="flat-red">
                    <label>
                      Tidak Aktif  
                    </label>
              </div>
