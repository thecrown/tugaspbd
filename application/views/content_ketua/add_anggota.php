        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <div class="box-body pad">
              <?php echo form_open('Ketua_dashboard/cek_validation_anggota'); ?>
              <div class="row">
              <div class="col-md-6">
                  <div class="form-group">
                  <label for="exampleInputPassword1">Nama Anggota</label>
                  <input type="text" class="form-control" name="nama_anggota" id="exampleInputPassword1" placeholder="Nama Anggota">
                  </div>
              </div>
              </div>
              <div class="form-group">
                  <label for="exampleInputPassword1">Alamat Anggota</label>
                <textarea class="ckeditor" name="alamat_anggota" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
              </div>
