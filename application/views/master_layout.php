...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php 
    if (isset($view_data)): 
      $this->load->view('Admin_dashboard/'.$view_data);

        elseif(isset($view_employee)):
            $this->load->view('Admin_dashboard/'.$view_employee);
    ?>
    <?php
    ...
    ?>
    <?php
        elseif(isset($Programer)):
            $this->load->view('content/'.$Programer);
        endif;
    ?>
    <!-- /.content -->
  </div>
